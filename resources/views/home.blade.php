    ...
    <div class="dashboard">
        ...
        <div class="sidebar">
            <div class="sidebar-logo" style="text-align:center; margin-bottom:30px;">
                <img src="{{ asset('img/hpp.png') }}" alt="Logo HPP"
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="#" class="menu-toggle"><i class="fas fa-briefcase"></i> Servicios <i
                ...
                <li>
                    ...
                    <ul class="sidebar-submenu">
                        <li>
                            <a href="{{ route('citas.index') }}" class="load-content"
                ...
                <li>
                    <a href="/logout" class="btn btn-danger w-100"
                        style="display:flex; align-items:center; justify-content:center; background:#e74c3c; color:#fff; padding:12px 0; border-radius:5px; text-decoration:none;">
